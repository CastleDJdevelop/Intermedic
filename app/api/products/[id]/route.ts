...
/**
 * Edita únicamente precio, costo promedio, mínimos/máximos de stock, precio de oferta
 * y `published` — los mismos campos que ya existían en Product. No toca
...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const status = e.message === "Producto no encontrado" ? 404 : 400;
